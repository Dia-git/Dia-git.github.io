...
This repository hosts my **personal GitHub Page**, available at:

https://dia-git.github.io/


Here, you’ll find:
- My **portfolio projects** in data analytics and bioinformatics.
- **Interactive visualizations** demonstrating research and data analysis methods.
- Occasional **articles** on applying computational methods to biological problems.
---

## 🚀 How to Contribute

If you’d like to suggest improvements, feedback, or new ideas:
...
## 🧠 Core Skills (Health, Bioinformatics & Data Analytics)

### Health & Bioinformatics Domain Knowledge
- Biology and bioinformatics foundations (BSc Biology, MSc Bioinformatics)
...
- KPI tracking, trend analysis, and performance metrics
- Insight communication and data storytelling
